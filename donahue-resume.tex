...
\vspace{-.3cm}
Plan and implement many aspects of Jibo that make him feel lifelike, produce dynamic behavior, and behave in a manner that is consistent with his character.
\begin{desc*}
\item[\rm \color{redblue} \textbf{Keywords}:] TypeScript,$\:$ NodeJS,$\:$ Electron,$\:$ HRI\\
\end{desc*}
