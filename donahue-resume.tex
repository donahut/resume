...
\section*{Experience}
\years{Sept 2020 --} 
\textbf{\fontsize{10.5pt}{1em}\selectfont Character AI Lead},
\textit{NTT Disruption}, Boston, MA\bigskip

\vspace{-.3cm}
Engineering Lead designing and implementing platforms, workflows, toolsets and interactions to provide Jibo with provide industry-leading conversation and character experiences.
...
%% \vspace{-.2cm}
\begin{desc*}
\item[\rm \color{redblue} \textbf{Keywords}:] C++, TypeScript\,/\,JS\,/\,Node,$\:$ Python,$\:$ NLP/NLU,$\:$ HRI \bigbreak
\end{desc*}
...
\vspace{-0.3cm}
\years{Core:}   
C++ \,(\,17\,),$\:$ Typescript\,/\,JS,$\:$ Python\\
\years{Rusty:}
Java,$\:$ Clojure,$\:$ HTML/\,CSS\\
\years{Familiar:}  
PHP,$\:$ SQL,$\:$ R\\
