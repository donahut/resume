...
\textit{Familiar Machines \& Magic}, Woburn, MA\bigskip

%% \vspace{-.3cm}                 
Currently in stealth mode --- utilizing robotics and AI to develop health-related solutions
...
%% \vspace{-.2cm}
%% \begin{desc*}
%% \item[\rm \color{redblue} Keywords:] C++,$\:$ ROS,$\:$ ZeroMQ,$\:$ Autonomous Robot,$\:$ HRI,$\:$ Linux \bigbreak
%% \end{desc*}
\bigskip
\years{2016 -- 2018} 
...
\textit{Withdrew in good standing from multi-disciplinary joint-Ph.D. program in Human-Robot Interaction}
