...
and exams.
\begin{desc*}
\item[Keywords:] C++, Shell scripting, Linux
\end{desc*}
...
\begin{desc*}
\item[Keywords:] Java, C++, HCI, Tangible/Touch UIs, Accessibility, Windows
\end{desc*}
...
Java, Python, C++\\
\years{Experienced:}  
JS, Clojure, PHP, HTML/CSS\\
\years{Exposure:}  
C, R, SQL, Scheme, SML, Prolog, MATLAB, CUDA\\
