...
% Managed local and remote teams of research assistants for long-term project
\begin{desc*}
...
%% \years{2012, 2013}
%% \textbf{Teaching Assistant}, \textsl{Computer Science Dept., Tufts
%%   University}, Medford, MA \\
%% Maintained automated testing suite for introductory C++ course.
%% Provided instruction to students during lab sections as well as office
%% hours. \\
...
benefits of and tradeoffs between mouse, touch and tangible input
systems.
\begin{desc*}
\item[Keywords:] Java, C++, HCI, Tangible/Touch UIs, Accesibility, Windows
\end{desc*}
...
Java, Python, C++\\
\years{Experienced:}  
PHP, JS, Clojure, HTML/CSS\\
\years{Exposure:}  
C, R, SQL, Scheme, SML, Prolog, CUDA\\

\vspace{-2.15cm}
\begin{minipage}[hr]{.9\textwidth}
  \flushright
  \begin{tabular}[h]{ll}
    & \textbf{Tools} \\[0.1cm]
