...
\vspace{-.3cm}
\textit{Mission:} Plan and implement many aspects of Jibo that make him feel lifelike, produce dynamic behavior, and behave in a manner that is consistent with his character.
\begin{desc*}
\item[\rm \color{redblue} \textbf{Keywords}:] JS/TypeScript,$\:$ NodeJS,$\:$ Electron,$\:$ HRI,$\:$ OSX,$\:$ Scrum\\
\end{desc*}
...
Python,$\:$ C++,$\:$ Java\\
\years{Proficient:}
JS,$\:$ HTML/CSS, $\:$ Clojure,$\:$ R,$\:$ PHP\\
%% \years{Exposure:}  
%% C,$\:$ Scheme,$\:$ SML,$\:$ SQL,$\:$ Prolog\\

\vspace{-1.75cm}
\begin{minipage}[hr]{.85\textwidth}
  \flushright
  \begin{tabular}[h]{ll}
    & \textbf{\fontsize{10.5pt}{1em}\selectfont Tools} \\[0.1cm]
    \skill{src Control:} & Git,$\:$ Subversion,$\:$ Gerrit \\
...
\vspace{-0.3cm}
\years{Linux:} 
Considerable Linux development experience and
comfortable with command line interfaces.\\
\years{Robotics:} 
Extensive development experience with both Aldebaran's NaoQi robotics
...
\section*{Education}
\years{2012 - 2014}
\textbf{Graduate studies in Computer Science}, \textit{Tufts
  University, Medford, MA}\\
\textit{Withdrew in good standing from Computer Science \& Cognitive
