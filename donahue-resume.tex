...
\textit{Aldebaran (Softbank Robotics)}, Boston, MA\\
...
\vspace{-.2cm}
\begin{desc*}
\item[\rm \color{Violet} \textbf{Keywords}:] Python,$\:$ JS,$\:$ C++,$\:$ HTML/\,CSS,$\:$
  HRI,$\:$ Linux,$\:$ Git,$\:$ Scrum\\
\end{desc*}
...
\vspace{-.2cm}
\begin{desc*}
\item[\rm \color{Violet} \textbf{Keywords}:] Java,$\:$ Clojure,$\:$ C++,$\:$
...
\vspace{-.2cm}
\begin{desc*}
\item[\rm \color{Violet} \textbf{Keywords}:] Java,$\:$ C++,$\:$ HCI,$\:$ Tangible/Touch UIs,$\:$ Accessibility,$\:$ Windows\\
\end{desc*}
