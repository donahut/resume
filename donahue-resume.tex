...
\section*{Experience}
\years{June 2018} 
\textbf{\fontsize{10.5pt}{1em}\selectfont Smart Behaviors Specialist},
\textit{Piaggio Fast Forward}, Boston, MA\bigskip

\vspace{-.3cm}
Member of the team that investigates, designs and implements high-level behaviors in Gita and beyond, focusing primarily on enabling and ensuring intuitive, seamless human-machine interactions in every situation.
%% \vspace{-.2cm}
\begin{desc*}
\item[\rm \color{redblue} \textbf{Keywords}:] Python,$\:$ C++,$\:$ HRI,$\:$ Ubuntu,$\,$ Git\bigbreak
\end{desc*}
...
\textit{Computer-Human Interaction Lab, Bowling Green State
  University}, Bowling Green, OH \bigskip
...
\textbf{\fontsize{10.5pt}{1em}\selectfont Languages}\bigskip
...
\begin{minipage}[hr]{0.9\textwidth}
  ...
  \begin{tabular}[h]{ll}
    ...
    \skill{Cloud/DB:}    & Docker,$\:$ MySQL,$\:$ Neo4j\\
...
\vspace{-0.3cm}
\years{Robotics:}
Extensive development experience with a range of robotics platforms, including Jibo, Softbank/\\\,Aldebaran's Pepper and Nao and ADE---a research-focused, distributed, multi-agent robotics middleware.\smallbreak
\years{Unix:}
...
\section*{Patents}
\years{2017}
Cynthia Breazeal, \textbf{Thomas Donahue}, et. al.\\
